    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-[#FFFAF0] to-[#FFF9F2]">
      <div className="container mx-auto px-6 text-center">
        <div className="flex justify-center mb-8">
            <img src="https://picsum.photos/seed/boloflix/400/300" alt="Ilustração de bolo caseiro" className="rounded-full shadow-2xl w-64 h-64 object-cover border-8 border-white"/>
        </div>
